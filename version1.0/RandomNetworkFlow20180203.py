...
matrixBLD = readCSV("BLD2018.csv")

#fileName = "wayProb2018.csv"
matrixWP = readCSV("wayProb2018.csv")

#capa: passageway capacity [way1Capa, way2Capa, ... waynCapa]
matrixCapa = readCSV("capa2018.csv")
matrixIS = readCSV("initialState2018.csv")


[Num_R, Num_P]=np.shape(matrixBLD)
...
print >>f, "Computing in iteration starts here!\n"
...
for t in range(0, T-1):
	...
	for j in range(0, Num_P):
		...
		print "OK. Well Done!"
		print >> f, "OK. Well Done!"
	    else:
		print "Something wrong here!"
		print >> f, "Something wrong here!"
